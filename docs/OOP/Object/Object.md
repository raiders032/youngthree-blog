...
## 19 개방 폐쇄 원칙: Open-Closed Principle
...
### 19.1 컴파일 타임 의존성을 고정시키고 런타임 의존성을 변경하라
...
## 20 의존성 역전 원칙: Dependency Inversion Principle
...
## 21. 인터페이스 분리 원칙: Interface Segregation Principle

## 22. 리스코프 치환 원칙: Liskov Substitution Principle
