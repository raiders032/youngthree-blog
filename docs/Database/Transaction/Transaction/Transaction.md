...
- 데이터 무결성에 대한 자세한 내용은 [데이터 무결성](../../Mysql/Data-Integrity/Data-Integrity.md)를 참고해주세요.
...
- 하지만 병렬적 수행의 장점을 얻기 위해서 DBMS는 병렬적으로 수행하면서도 일렬(serial) 수행과 같은 결과를 보장할 수 있는 방식을 제공하고 있습니다.
	- [Isolation Levels](../../Isolation-Levels/Isolation-Levels.md)에 대한 자세한 내용은 여기를 참고해주세요.
